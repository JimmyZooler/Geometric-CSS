...
<div class="top-bar" id="top-bar-menu">
	<div class="top-bar-left float-left">
		<ul class="menu">
			<li><a id="logo-name" href="<?php echo home_url(); ?>"><img id="logo" src="http://localhost/geometric/wp-content/themes/geometric-css/assets/images/geometric_trim_white.png"><?php bloginfo('name'); ?></a></li>
		</ul>
